...
python /Users/pedrobaiz/src/oecd_financial_flows/notebooks/examples-transformers/text-classification/run_glue.py \
  ...
  --output_dir /Users/pedrobaiz/src/oecd_financial_flows/data/processed/glue/$TASK_NAME/
```
...
python /Users/pedrobaiz/src/oecd_financial_flows/notebooks/examples-transformers/text-classification/run_glue.py \
  ...
  --learning_rate 2e-5 \
  --num_train_epochs 3.0 \
  --output_dir /Users/pedrobaiz/src/oecd_financial_flows/data/processed/glue/mrpc_output/
```
